...
import com.spring.wintermarket.carts.properties.ProductServiceIntegrationProperties;
...
@Configuration
@EnableConfigurationProperties(ProductServiceIntegrationProperties.class) // аннотация для подключения пропертей
