...
import com.spring.wintermarket.core.properties.CartServiceIntegrationProperties;
...
@Configuration
@EnableConfigurationProperties(CartServiceIntegrationProperties.class) // аннотация для подключения пропертей
